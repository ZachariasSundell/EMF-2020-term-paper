...
# STATIONARITY: 
# ADF unit root test for stationarity of time-series (HO: Time-Series is stationary)
...
kpss1SSEC
# All test indicate stationarity of time-series (H0 is rejected at at least 5% level for test statistic). 
# Ljung-Box test for autocorrelation. H0: time-series is independent at all lags
...
arma_SSEC1
# LM-ARCH test for conditional heteroskedacticity of ARMA(p,q) model residuals. H0: the squared residuals are a sequence of white noise, namely, the residuals are homoscedastic
...
# Li-Mak test for presence of autocorrelation in the residuals (if there is it's poopoo) (fitdf = p+q) (lag based on .... suggestion)
...
DCCARCH1_SSEC
# Ljung-Box test for autocorrelation in squared standardized residuals. H0: residual-series is independent at all lags
